...
class TAESD(nn.Module):
    ...
    def __init__(self, encoder_path="models/taesd_encoder.pth", decoder_path="models/taesd_decoder.pth", latent_channels=None):
...
def main():
    ...
    taesd = TAESD().to(dev)
    for im_path in ["images/test_image.jpg"]:
